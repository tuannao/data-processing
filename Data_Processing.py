...
def write_csv(path, new_data):
    path_log = "E:\programming\Python\Asm_2_BI\Data_ASM2\log.txt"
...
if __name__ == '__main__':
    ...
    # Path of files
    path_revenue = "E:\programming\Python\Asm_2_BI\Data_ASM2\sales_revenue.csv"
    path_quantity = "E:\programming\Python\Asm_2_BI\Data_ASM2\sales_product_cat.csv"
    path_new = "E:\programming\Python\Asm_2_BI\Data_ASM2\sales_new.csv"
    bc = Bcolors()
    ...
    while True:
        ...
        print("Enter (" + bc.OKBLUE + "3" + bc.ENDC + ") : " + bc.WARNING + "{0:38s}".format("Clean data") + bc.ENDC)
        print("Enter (" + bc.OKBLUE + "4" + bc.ENDC + ") : " + bc.FAIL + "{0:38s}".format("Exit") + bc.ENDC)
        print("-" * 64)
